...
with open(utils.buildFileName("_plays", 'csv'), mode='a', encoding='utf8') as csv_file:
...
with open(utils.buildFileName("_likes", 'csv'), mode='a', encoding='utf8') as csv_file:
    writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    writer.writeheader()
...
with open(utils.buildFileName("_shares", 'csv'), mode='a', encoding='utf8') as csv_file:
    writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
    writer.writeheader()
